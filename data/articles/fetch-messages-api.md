---
title: "Fetch Messages API"
slug: fetch-messages-api
url: https://dev.sprinklr.com/fetch-messages-api
---
...
Using this API, you can fetch the messages within a live chat conversation.

## API Endpoint

https://{env}-live-chat.sprinklr.com/api/livechat/v1/conversation/fetchMessages
...
| size | Optional | Refers to the number of results you want to fetch per API call | Integer |
| cursor | Optional | Refers to the beforeCursor or afterCursor string from the API response, which can be used to fetch the previous or next set of results | Integer |
...
curl -X GET \
 'https://{env}-live-chat.sprinklr.com/api/livechat/v1/conversation/fetchMessages?conversationId=653a34fa4b4051546cb90516&size=1'\
...
[](https://dev.sprinklr.com/fetch-messages-api)

[Back to top](https://dev.sprinklr.com/fetch-messages-api)
