---
title: "External Read Campaign"
slug: external-read-campaign
url: https://dev.sprinklr.com/external-read-campaign
---

# External Read Campaign

#
  GET External Read Campaign

Find campaign by external campaign details and you will get the data corresponds a External Campaign {Id} and other related objects as Response after making the Request.
...
| externalSourceId | Id of the external source. | String |
 ...
 [](https://dev.sprinklr.com/external-read-campaign)
...
[Back to top](https://dev.sprinklr.com/external-read-campaign)
