---
title: "Start Live Stream Chat Event"
slug: start-live-stream-chat-event
url: https://dev.sprinklr.com/start-live-stream-chat-event
---

# Start Live Stream Chat Event

#
  GET Start Live Stream Chat Event
...
https://api3.sprinklr.com/{env}/api/v2/live-chat/start-live-stream-event/{Id}
...
Copy Code
 ...
 curl -X GET \
 'https://api3.sprinklr.com/{env}/api/v2/live-chat/start-live-stream-event/63aeaeede3316b2f6ba4fcfb' \
...
[](https://dev.sprinklr.com/start-live-stream-chat-event)




[Back to top](https://dev.sprinklr.com/start-live-stream-chat-event)
