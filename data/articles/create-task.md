...
title: "Create Task"
slug: create-task
url: https://dev.sprinklr.com/create-task
---
...
#
 POST  Create Task
	...
	You can create a Task via this API call and you will get the Id and other related objects as Response after making the Request.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/task
...
| attachment |  | Optional | The object containing attachment details of the task. |  |
 ...
 https://api3.sprinklr.com/{{env}}/api/v2/task \
  ...
  -d'{
        ...
        "attachment": {
            ...
            "title": "@TIN What is this? https://t.co/tHVVfIKgI6",
...

{
    "data": {
        ...
        "queueDetails": [
            {
                "queueId": 100623,
                "assignmentTime": 1594115419177
            }
        ],
        "createdTime": 1594115419177,
        "modifiedTime": 1594115419177
    },
    "errors": []
}
...
[](https://dev.sprinklr.com/create-task)




[Back to top](https://dev.sprinklr.com/create-task)
