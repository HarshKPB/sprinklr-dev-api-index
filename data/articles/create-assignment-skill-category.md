---
title: "Create Assignment Skill Category"
slug: create-assignment-skill-category
url: https://dev.sprinklr.com/create-assignment-skill-category
---

# Create Assignment Skill Category

#
  POST - Create Assignment Skill Category

Use this API to create a skill category.
...
| shareConfigs | Array for share configurations (currently empty). | Array |
...
[](https://dev.sprinklr.com/create-assignment-skill-category)
...
[Back to top](https://dev.sprinklr.com/create-assignment-skill-category)
