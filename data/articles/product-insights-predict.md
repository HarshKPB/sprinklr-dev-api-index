---
title: "Product Insights Predict"
slug: product-insights-predict
url: https://dev.sprinklr.com/product-insights-predict
---

# Product Insights Predict

#
  POST  Product Insights Predict


The Product Insights Predict API is capable of identifying common trends within unstructured data to apply structure and drive analysis based on modeling structure of respective business. Using this API, you can make a prediction request on a single message i.e., one at a time.
...
https://api3.sprinklr.com/`{env}`/api/v2/intuition/product-insights/predict
...
[](https://dev.sprinklr.com/product-insights-predict)




[Back to top](https://dev.sprinklr.com/product-insights-predict)
