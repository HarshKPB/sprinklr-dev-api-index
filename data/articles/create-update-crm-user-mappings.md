---
title: "Create/Update CRM User Mappings"
slug: create-update-crm-user-mappings
url: https://dev.sprinklr.com/create-update-crm-user-mappings
---

# Create/Update CRM User Mappings

#
  PUT - Create/Update CRM User Mappings


Using this API, you can create or update CRM user mapping for the given CRM and SPR user Id.
...
**Dev Note: **If either of the CRM user Id or SPR user Id exist, the mapping will be updated. And, if both the SPR user Id and CRM user Id are unique, a new mapping will be created.
...

{
    "data": {
        ...
        "lastModifiedTime": 1720101570188
    },
    "errors": []
}
...
[](https://dev.sprinklr.com/create-update-crm-user-mappings) 

 

 
[Back to top](https://dev.sprinklr.com/create-update-crm-user-mappings)
