---
title: "Read Case by Channel Case Number"
slug: read-case-by-channel-case-number
url: https://dev.sprinklr.com/read-case-by-channel-case-number
---

# Read Case by Channel Case Number

#
  GET - Read Case by Channel Case Number

You can read a case through channel case number with this API call. This call allows you to get case data in JSON.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/case/channel-case-numbers
...
| --- | --- | --- | --- |
| channel-case-numbers | Required | Channel case number of the case you want to fetch. | String |
...
curl -X GET \
  https://api3.sprinklr.com/{env}/api/v2/case/channel-case-numbers?channelCaseNumbers=123 \
...
[](https://dev.sprinklr.com/read-case-by-channel-case-number)




[Back to top](https://dev.sprinklr.com/read-case-by-channel-case-number)
