---
title: "Accept Backfill 2.0"
slug: accept-backfill-2-0
url: https://dev.sprinklr.com/accept-backfill-2-0
---
...
Once you get the backfill estimate via [Read Backfill API](https://dev.sprinklr.com/read-backfill-2-0), you can use this API to accept the backfill using backfill Id and as response you will get the backfill details along with `status` and `estimatedDataCount` and other related objects.

**Note: ** Please reach out to your Success Manager to get the Backfill API's enabled for your environment.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/listening-topic-backfill/accept/{Id}
...
curl -X PUT \
   'https://api3.sprinklr.com/{env}/api/v2/listening-topic-backfill/accept/6048bcca626a361cc11e954e' \
...
[](https://dev.sprinklr.com/accept-backfill-2-0)




[Back to top](https://dev.sprinklr.com/accept-backfill-2-0)
