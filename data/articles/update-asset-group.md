...
slug: update-asset-group
url: https://dev.sprinklr.com/update-asset-group
---
...
You can update an Asset group via this API call and you will get the Id and other updated objects as Response after making the Request.
...
| ids | IDs based on type. | String |
	 ...
	 [](https://dev.sprinklr.com/update-asset-group)




[Back to top](https://dev.sprinklr.com/update-asset-group)
