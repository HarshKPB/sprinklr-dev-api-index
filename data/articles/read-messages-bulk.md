---
title: "Read Messages (Bulk)"
slug: read-messages-bulk
url: https://dev.sprinklr.com/read-messages-bulk
---
...
| sizeInBytes | Refers to the size of the attachment file in bytes  Dev Notes: This metric is governed by a Dynamic Property (DP). To retrieve this metric, it must first be enabled in your environment. Reach out to your Success Manager or submit a support ticket at . | String |
...
[](https://dev.sprinklr.com/read-messages-bulk)




[Back to top](https://dev.sprinklr.com/read-messages-bulk)
