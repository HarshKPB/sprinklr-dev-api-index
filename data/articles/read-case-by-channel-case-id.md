---
title: "Read Case by Channel Case Id"
slug: read-case-by-channel-case-id
url: https://dev.sprinklr.com/read-case-by-channel-case-id
---

# Read Case by Channel Case Id

#
  GET - Read Case by Channel Case Id

You can fetch a case through channel case id with this API call. This call allows you to get case data in JSON.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/case/channel-case-ids
...
| --- | --- | --- | --- |
| channel-case-ids | Required | Channel case id of the case for which you want to run this API call. | String |
...
curl -X GET \
  https://api3.sprinklr.com/{env}/api/v2/case/channel-case-ids?channelCaseIds=123 \
...
[](https://dev.sprinklr.com/read-case-by-channel-case-id)




[Back to top](https://dev.sprinklr.com/read-case-by-channel-case-id)
