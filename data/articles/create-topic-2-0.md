---
title: "Create Topic 2.0"
slug: create-topic-2-0
url: https://dev.sprinklr.com/create-topic-2-0
---
...
You can use this end-point is to create Listening Topic. After making the API Request, in response you will receive the Complete Listening Topic with unique Id.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/listening-topic
...

{
    "data": {
        ...
        "onlyVerifiedUser": false,
        "createdTime": 1679757114102,
        "modifiedTime": 1679757114102,
...
**Note: **The Request and Response object/fields are almost same, only the response will have ` id, createdTime, modifiedTime, ownerUserId, lastModifiedUserId` as additional fields.
...
[](https://dev.sprinklr.com/create-topic-2-0)




[Back to top](https://dev.sprinklr.com/create-topic-2-0)
