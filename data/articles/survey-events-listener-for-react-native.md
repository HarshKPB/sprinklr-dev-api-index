---
title: "Survey Events Listener for React Native"
slug: survey-events-listener-for-react-native
url: https://dev.sprinklr.com/survey-events-listener-for-react-native
---

# Survey Events Listener for React Native
...
registerEventHandler(callback: (eventType: EventType, eventData: string) => void): void
...
import { registerEventHandler, EventType } from '@sprinklrjs/survey-kit';
registerEventHandler((eventType: EventType, eventData: string) => {
  ...
  switch (eventType) {
    ...
    case EventType.SURVEY_FORM_DISPLAY_SUCCESS:
      console.log('📋 Survey displayed to user');
      break;
...
[](https://dev.sprinklr.com/survey-events-listener-for-react-native)

[Back to top](https://dev.sprinklr.com/survey-events-listener-for-react-native)
