---
title: "Update Topic Group 2.0"
slug: update-topic-group-2-0
url: https://dev.sprinklr.com/update-topic-group-2-0
---

# Update Topic Group 2.0

#
  PUT - Update Topic Group


	You can update a Listening Topic Group via this API call and you will get the updated Topic Group object as response after making the request.
...
| --- | --- | --- | --- |
| Id | Required | The unique Id of the Topic Group.. | String |
...
| Fields | Sub-Fields | Reuired/Optional | Description | Type |
| --- | --- | --- | --- | --- |
| id |  | Required | Refers to the topic group idThis is same id that you configure in the path parameters | String |
...
curl -X PUT \
  'https://api3.sprinklr.com/{env}/api/v2/listening-topic-group/603f952b9edad172a0ce0d97' \
  -H 'Authorization: Bearer {Enter your Access Token}' \
  -H 'Key: {Enter your API KEY}' \
  -H 'Content-Type: application/json' \
  -d '{
    "id": "603f952b9edad172a0ce0d97",
    "description":"This is a test topic group",
...
[](https://dev.sprinklr.com/update-topic-group-2-0)




[Back to top](https://dev.sprinklr.com/update-topic-group-2-0)
