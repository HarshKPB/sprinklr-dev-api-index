---
title: "Case Lifecycle - CRM Integration Blueprint"
slug: case-lifecycle-crm-integration-blueprint
url: https://dev.sprinklr.com/case-lifecycle-crm-integration-blueprint
---

# Case Lifecycle - CRM Integration Blueprint
...
- Set up Webhook subscription using the steps mentioned in [Create and Manage Webhook Subscription](https://www.sprinklr.com/help/articles/platform-modules/create-and-manage-webhook-subscription-in-sprinklr/633c5c2b59534970b26f96da) Knowledge Base article
...
**Related Knowledge Base Article**: [About Case Maker](https://www.sprinklr.com/help/articles/case-maker/case-maker/6404bc887a695d65a16065993)
...
**Related Dev Portal Documentation**: Channel Case Details API
...
**Related Knowledge Base Article**: [About Assignment Engine](https://www.sprinklr.com/help/articles/introduction-to-assignment-engine/what-is-the-assignment-engine/645b725e0104980882a5a6f0)
...
**Related Dev Portal Documentation**: Case Update API
...
**Related Knowledge Base Article**: [Respond to Messages from Agent Console](https://www.sprinklr.com/help/articles/agent-console-legacy/sending-canned-responses-from-agent-console/63d8c508405d8861d65a9c81)
...
**Related Dev Portal Documentation**: Read Message by Id
...
**Related Dev Portal Documentation**: Read Message (Bulk)

**Dev Notes: **Once you have the message's content, repeat the steps listed in [4.2.2](https://dev.sprinklr.com/case-lifecycle-crm-integration-blueprint#18) for publishing the message.
...
**Related Dev Portal Documentation**: Message Properties Update API

## 6. Case Update

Whenever any of the case custom properties are updated by the agent, the respective case gets updated within Sprinklr.

**Related Knowledge Base Article**: [Case Creation and Update Rules](https://www.sprinklr.com/help/articles/types-of-rules/case-update-and-case-creation-rules/63f1c7a5e024591337249c7b)
...
**Related Knowledge Base Article**: [Case Macros](https://www.sprinklr.com/help/articles/macros-kb/case-macros/63370e48a0522e093b06b442)
...
[](https://dev.sprinklr.com/case-lifecycle-crm-integration-blueprint)

[Back to top](https://dev.sprinklr.com/case-lifecycle-crm-integration-blueprint)
