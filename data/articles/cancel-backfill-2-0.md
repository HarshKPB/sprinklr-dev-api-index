---
title: "Cancel Backfill 2.0"
slug: cancel-backfill-2-0
url: https://dev.sprinklr.com/cancel-backfill-2-0
---
...
You can use this API to cancel the triggered backfill using backfill Id and as response you will get the backfill details along with backfill `status` and other related objects.

**Note: ** Please reach out to your Success Manager to get the Backfill API's enabled for your environment.

## API Endpoint

https://api2.sprinklr.com`/{env}/`api/v2/listening-topic-backfill/cancel/{Id}
...
curl -X PUT \
   'https://api2.sprinklr.com/{env}/api/v2/listening-topic-backfill/cancel/6048bcca626a361cc11e954e' \
...
[](https://dev.sprinklr.com/cancel-backfill-2-0)




[Back to top](https://dev.sprinklr.com/cancel-backfill-2-0)
