---
title: "Create Content Brief v1"
slug: create-content-brief-v1
url: https://dev.sprinklr.com/create-content-brief-v1
---

# Create Content Brief v1
...
Using this API, you can create a content brief. Once a brief has been created, you can use it in a Campaigns.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v1/content/brief/create
...
| clientCustomProperties | Optional | The object containing client custom properties. | Object |
| partnerCustomProperties | Optional | The object containing partner custom properties. | Object |
...
[](https://dev.sprinklr.com/create-content-brief-v1)




[Back to top](https://dev.sprinklr.com/create-content-brief-v1)
