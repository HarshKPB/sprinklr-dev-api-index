...
title: "Create User"
slug: create-user
url: https://dev.sprinklr.com/create-user
---
...
https://api3.sprinklr.com`/{env}/`api/v2/scim
    ...
    "data": {
{
    "data": {
        ...
        "meta": {
            "resourceType": "User",
            "location": "/api/scim1000204432"
        },
        "emails": [
            {
                "value": "test@sprinklr.com",
                "primary": true
            }
        ]
    },
...
[](https://dev.sprinklr.com/create-user)




[Back to top](https://dev.sprinklr.com/create-user)
