...
title: "Read User"
slug: read-user
url: https://dev.sprinklr.com/read-user
---
...
#
  GET - Read User
	...
	You can fetch a user through user Id via this API call. After making the GET Request, you will get the user details in JSON format as Response.
...
| --- | --- | --- | --- |
| userId | Required | The userId which needs to be fetched. | String |
...
**Dev Notes: ** When making a request to the API to retrieve user information, if the specified user id is not found in the database, the API will return a 404 error.
[](https://dev.sprinklr.com/read-user) 

 

 
[Back to top](https://dev.sprinklr.com/read-user)
