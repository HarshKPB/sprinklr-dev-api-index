---
title: "Bulk Add Contacts in Suppression List"
slug: bulk-add-contacts-in-suppression-list
url: https://dev.sprinklr.com/bulk-add-contacts-in-suppression-list
---

# Bulk Add Contacts in Suppression List

#
 POST  Bulk Add Contacts in Supression List



Using this API, you can add multiple customer phone numbers to a list that should not be contacted by the brand. This list could include phone numbers of individuals who have requested to be placed on the "do not call" list, those who have previously asked to be removed from the calling list, those who do not match the targeted persona anymore, or those who are considered ineligible for certain types of calls (e.g., for regulatory or compliance reasons).

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/suppressionList/addContacts
...
curl -X POST \
 'https://api3.sprinklr.com/{env}/api/v2/suppressionList/addContacts' \
  ...
  -d '[
    {
        "name": "supress 1",
        "contactValue": "+91123457821",
        "suppressionListId": "64117bafd0ce437fdcad3e80",
        "expiryTime": "1686053410000",
        "createdTime": "1676630765000"
    },
    {
        "name": "supress 2",
        "contactValue": "+918447623412",
        "suppressionListId": "64117bafd0ce437fdcad3e83",
        "expiryTime": "1686053410000",
        "createdTime": "1676630765000"
    }
]'
...
[](https://dev.sprinklr.com/bulk-add-contacts-in-suppression-list)




[Back to top](https://dev.sprinklr.com/bulk-add-contacts-in-suppression-list)
