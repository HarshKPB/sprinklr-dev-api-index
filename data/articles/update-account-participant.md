---
title: "Update Account Participant"
slug: update-account-participant
url: https://dev.sprinklr.com/update-account-participant
---

# Update Account Participant

#
  POST Update Account Participant




This API helps link the participant with the given account Id.

## API Endpoint

https://api3.sprinklr.com`/{env}/`/api/v2/account/update-account-participant

**Dev Notes: **You need to make this API call immediately after creating the participant to link that participant with the social account on Sprinklr
...
curl -X POST \'https://api3.sprinklr.com/{env}/api/v2/account/update-account-participant '\
...
[](https://dev.sprinklr.com/update-account-participant)




[Back to top](https://dev.sprinklr.com/update-account-participant)
