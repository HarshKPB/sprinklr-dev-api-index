---
title: "Fetch Profile by sntype and snUserId"
slug: fetch-profile-by-sntype-and-snuserid
url: https://dev.sprinklr.com/fetch-profile-by-sntype-and-snuserid
---

# Fetch Profile by sntype and snUserId

#
  GET Fetch Profile by sntype and snUserId


	Using this API, you can fetch the data and metadata (stored in Sprinklr) associated with a profile for the given snType (channel type) and snUserId (unique identifier for profile).
...
| snUserId | Required | Refers to the profile Id of the userYou can find this Id from the properties section mentioned under user profile on Sprinklr's platform | String |
...
Copy Code
 ...
 curl -X GET \
  'https://api3.sprinklr.com/{env}/api/v2/profile?snType=TWITTER&snUserId=1556005385642905603' \
...
[](https://dev.sprinklr.com/fetch-profile-by-sntype-and-snuserid)




[Back to top](https://dev.sprinklr.com/fetch-profile-by-sntype-and-snuserid)
