---
title: "Fetch Assignment Skill Category by Name"
slug: fetch-assignment-skill-category-by-name
url: https://dev.sprinklr.com/fetch-assignment-skill-category-by-name
---

# Fetch Assignment Skill Category by Name

#
  GET - Fetch Assignment Skill Category by Name

Use this API to fetch the details of a skill category by its name.

## API Endpoint

https://api3.sprinklr.com`/{env}/`api/v2/unified-routing/skill-category?name={skill_category_name}
...
| --- | --- | --- | --- |
| {skill_category_name} | Required | The name of the skill category for which you want to retrieve the details. The name of the skill category can be found in the Sprinklr UI. | String |
...
curl -X GET \
  'https://api3.sprinklr.com/{env}/api/v2/unified-routing/skill-category?name=test' \
...
[](https://dev.sprinklr.com/fetch-assignment-skill-category-by-name)
...
[Back to top](https://dev.sprinklr.com/fetch-assignment-skill-category-by-name)
