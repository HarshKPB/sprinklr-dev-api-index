---
title: "Fetch Categories Using Parent Id"
slug: fetch-categories-using-parent-id
url: https://dev.sprinklr.com/fetch-categories-using-parent-id
---

# Fetch Categories Using Parent Id

#
Fetch Categories Using Parent Id


This API helps fetch topics and categories that fall under the given category parent Id.
...
| --- | --- | --- | --- |
| parentId | Optional | Refers to the category parent Id | String |
...
**Dev Notes: **For every category returned in the response, the child topics and categories are appended up to one level
	 ...
	 [](https://dev.sprinklr.com/fetch-categories-using-parent-id)

[Back to top](https://dev.sprinklr.com/fetch-categories-using-parent-id)
