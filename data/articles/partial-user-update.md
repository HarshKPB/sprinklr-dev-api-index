---
title: "Partial User Update"
slug: partial-user-update
url: https://dev.sprinklr.com/partial-user-update
---

# Partial User Update

#
  PUT - Partial User Update
...
https://api3.sprinklr.com`/{env}/`api/v2/scim/update/{userId}
...
## Global Attributes Sub Parameters
...
| --- | --- | --- | --- |
| partnerCustomPropertiesUpdateRequest | Optional | The partner custom properties you want to update for a user.   "globalAttributes": {         "partnerCustomPropertiesUpdateRequest": {             "partnerCustomProperties": {                 "58d12dcbe4b084d89jkg0cd9": [                     "XYZ"                 ],                 "58d12dcbe4b084d9ijkhb679": [                     "XYZ"                 ]             }         },         "federationId": "",         "passwordLoginDisabled": false     }, | Map<String, List<String>> |
  ...
  "globalAttributes": {
        "partnerCustomPropertiesUpdateRequest": {
            " "partnerCustomProperties": {
                "58d12dcbe4b084d89jkg0cd9": [
                    "XYZ"
                ],
                "58d12dcbe4b084d9ijkhb679": [
                    "XYZ"
                ]
            }
        },
...
   
 
[](https://dev.sprinklr.com/partial-user-update) 

 

 
[Back to top](https://dev.sprinklr.com/partial-user-update)
